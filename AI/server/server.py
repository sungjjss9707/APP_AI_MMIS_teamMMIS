...
# 필요 data 읽기
data = pd.read_csv("/AI\ file/data.csv", encoding="UTF-8")
w2v_menu_sim_sorted_idx=np.load("/AI\ file/w2v_menu_sim_sorted_idx.npy")
bigram_menu_sim_sorted_idx=np.load("/AI\ file/bigram_menu_sim_sorted_idx.npy")
menus = pd.read_csv('/AI\ file/국방부메뉴_v2.1_맛_점수_포함.csv', index_col=0)
vectorizer_b1 = pickle.load(open('/AI\ file/vectorizer_b1.pk', 'rb'))
vectorizer_t1 = pickle.load(open('/AI\ file/vectorizer_t1.pk', 'rb'))
vectorizer_b2 = pickle.load(open('/AI\ file/vectorizer_b2.pk', 'rb'))
vectorizer_t2 = pickle.load(open('/AI\ file/vectorizer_t2.pk', 'rb'))
x_min_max_scaler = joblib.load('/AI\ file/x_min_max_scaler.save')
y_min_max_scaler = joblib.load('/AI\ file/y_min_max_scaler.save')
model = pickle.load(open('/AI\ file/ridge_v1.0.sav', 'rb'))
